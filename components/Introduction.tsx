            ...
            <div className="w-full h-full bg-gradient-to-r from-[#131424]/10 via-black/30 to-black/10">
                <div className="container grid items-center h-full px-5 mx-auto md:grid-cols-2 md:text-left">
                    ...
                    <motion.div className="w-auto h-auto mx-auto md:block px-10"
                        ...
                        exit="hidden"
                    >
                        <h1 className=" text-4xl leading-tight md:mb-10">Si puedes pensarlo,  <br />
                        ...
                        <div className="flex flex-col items-center gap-3 md:gap-10 md:flex-row">
                            ...
                            <a href="/contact" className="px-6 py-3 my-2 transition-all border-2 cursor-pointer text-secondary border-secondary rounded-xl hover:shadow-xl hover:shadow-white/50">
                                Contacta conmigo
                            </a>
                        </div>
                    </motion.div>
